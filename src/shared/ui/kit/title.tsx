...
const titleVariants = cva(
  'font-trjn-davinci transition duration-300 ease-in-out',
  {
    variants: {
      size: {
        lg: 'text-lg',
        ...
        '2xl': 'text-2xl',
        '3xl': 'text-[32px]',
        '4xl': 'text-[40px] leading-[40px] max-md:text-[32px]',
        '5xl': 'text-5xl',
        '6xl': 'text-[64px] max-md:text-[42px]',
        '7xl':
          'text-[80px] leading-[80px] max-md:text-[40px] max-md:leading-[40px]',
      },
      color: {
        white: 'text-white',
        jaguar: 'text-jaguar',
